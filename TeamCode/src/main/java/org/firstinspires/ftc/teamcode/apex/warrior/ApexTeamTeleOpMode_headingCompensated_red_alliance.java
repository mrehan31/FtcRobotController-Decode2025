...
@TeleOp(name = "Robot Manual Drive-red_alliance", group = "Linear Opmode")
public class ApexTeamTeleOpMode_headingCompensated_red_alliance extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            double heading_deg = curPos.getHeading(AngleUnit.DEGREES) - 90.0;
            ...
            mecanumDriveGamepadOneJoyStickControlled(theta);
    ...
    private void mecanumDriveGamepadOneJoyStickControlled(double heading_rad) {
        ...
        double vx = gamepad1.right_stick_y, vy = gamepad1.right_stick_x, omega = gamepad1.left_stick_x;

        double cosA = Math.cos(heading_rad);
        double sinA = Math.sin(heading_rad);
        double vx_compensated =  cosA * vx + sinA * vy;
        double vy_compensated = -sinA * vx + cosA * vy;
        vx = vx_compensated;
        vy = vy_compensated;

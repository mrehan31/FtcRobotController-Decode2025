...
@Autonomous(name = "Rehan Auto Drive - Blue Team - Far from goal", group = "Auto Opmode")
public class ApexTeamAutoModeLeftFar extends LinearOpMode {
...
//    /* Declare OpMode members */
//    RobotHardwareConfigurator myRobotHW = new RobotHardwareConfigurator();
//    private static final double shooterDCMotorPowerScaleFactor = 0.43;
...
//            long curTime = System.currentTimeMillis();
//            if (curTime - time_phase2 > 8000 ) {
//                target = new Pose2d(-620.0, -250.0, -90.0);
//            }
//
//            if (curTime - time_phase2 > 13000 ) {
//                target = new Pose2d(-620.0, -1050, -90.0);
//            }
//
...
//                }
//            }
//            if(curTime - time_phase1 > 8000 ) {
//                stopShooterDCMotors();
//                feederEnablerServo.setPosition(FEEDER_SERVO_POS_0_DEG);
//                sleep(22000);   // wait 800 ms
//            }
//        }
//    }
//        /// /////////////////////////////////////////////
